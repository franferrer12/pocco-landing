...
// every real, indexable route: the home page, the three standalone legal
...
// footer.tsx and each page's own file for why both forms exist), the
// /eventos index, and one entry per currently-upcoming event under
// /eventos/[slug] — sourced live from the same Fourvenues API data those
// pages themselves render from, so the sitemap never drifts out of sync
